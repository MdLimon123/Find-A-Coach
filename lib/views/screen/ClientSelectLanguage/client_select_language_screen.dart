...
class ClientSelectLanguageScreen extends StatefulWidget {
  const ClientSelectLanguageScreen({super.key});

  @override
  State<ClientSelectLanguageScreen> createState() => _ClientSelectLanguageScreenState();
}

class _ClientSelectLanguageScreenState extends State<ClientSelectLanguageScreen> {
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                      SizedBox(height: 50,),
                      Text("selectYourLanguage".tr, // Changed
                        style: TextStyle(
                      ...
                      SizedBox(height: 8,),
                      Text("chooseLanguageComfort".tr, // Changed
                        style: AppStyles.h4(
