...
class CoachCreateDiscussionScreen extends StatefulWidget {
  ...
  @override
  State<CoachCreateDiscussionScreen> createState() => _CreateDiscussionScreenState();
}

class _CreateDiscussionScreenState extends State<CoachCreateDiscussionScreen> {
